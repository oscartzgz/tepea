class ApplicationSettingsController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @application_setting.update(application_setting_params)
        format.html { redirect_to dashboard_application_settings_url, notice: 'Configuracion de Application fue actualizada.' }
  ...
  private
    ...
    def application_setting_params
      params.require(:application_setting).permit(:setting, :value)
    end
end
